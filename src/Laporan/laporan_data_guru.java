...
public class laporan_data_guru extends javax.swing.JFrame {
 private Connection conn = new koneksi().connect();
    ...
    public void cetak() {
        try {
            String path = "./src/Laporan/report_dataguru.jasper";
            HashMap parameter = new HashMap();
            //String cariitem = txtcari.getText();
            parameter.put("NIP", txt_cari.getText());
 ...
 protected void datatable() {
        ...
        try {
            String sql = "SELECT * FROM guru where nip like '%" + cariitem + "%'"
                    + "or nama_guru like '%" + cariitem + "%'"
                    + "order by NIP asc";
    ...
    private void initComponents() {
        ...
        btn_close.setMaximumSize(new java.awt.Dimension(89, 39));
        btn_close.setMinimumSize(new java.awt.Dimension(89, 39));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(12, 12, 12)
                        .addComponent(txt_cari, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
