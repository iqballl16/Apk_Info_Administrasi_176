 ...
 */
public class laporan_data_absensi extends javax.swing.JFrame {
 private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    /**
     * Creates new form data absensi
     */
    public laporan_data_absensi() {
        initComponents();
    ...
    public void cetak() {
        try {
            String path = "./src/Laporan/report_dataabsensi.jasper";
 ...
 protected void datatable() {
        ...
        try {
            String sql = "SELECT * FROM absensi where nis like '%" + cariitem + "%'"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(laporan_data_absensi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new laporan_data_absensi().setVisible(true);
            }
        });
    }
